<footer class="w-full relative bg-primary dark:bg-primary-container mt-20">
    <div
        ...
        <div class="col-span-1">
            <div class="text-[1.5rem] font-headline-md text-on-primary dark:text-on-primary-container mb-6">
                Action Misericorde
            </div>
            <p class="text-on-primary/70 text-label-sm mb-6 max-w-xs">
                Travaillant sans relâche pour l'équité environnementale et l'autonomie des communautés depuis plus d'une
                décennie.
            </p>
            <div class="flex gap-4">
                <a class="text-[#ffffff] rounded-full w-10 h-10 border border-on-primary/20 flex items-center justify-center text-on-primary hover:bg-on-primary hover:text-primary transition-all"
                    href="#">
